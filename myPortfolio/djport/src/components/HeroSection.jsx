    ...
    <section id="hero" className="relative flex flex-col items-center justify-center min-h-screen text-center px-4">
        <div className="container max-w-4xl mx-auto text-center z-10">
            <div className="space-y-6">
                ...
                <p className="text=lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3"> 💻Aspiring Full Stack Java Developer || Springboot || Skilled with SQL and Angular || Rest APIs || Tech Enthusiast || Problem Solving and Debugging</p>
